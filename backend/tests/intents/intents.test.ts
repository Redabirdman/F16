...
const KNOWN_INTENTS: ReadonlyArray<[string, z.ZodTypeAny]> = [
  ...
  ['SUBSCRIPTION.REQUESTED', intents.SubscriptionRequestedPayload],
  ['SUBSCRIPTION.READY', intents.SubscriptionReadyPayload],
  ['SUBSCRIPTION.FAILED', intents.SubscriptionFailedPayload],
